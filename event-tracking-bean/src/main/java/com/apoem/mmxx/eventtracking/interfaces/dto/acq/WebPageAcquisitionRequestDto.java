 ...
 * <p>Name: WebPageAcquisitionRequestDto </p>
 * <p>Description: 网页端埋点上报数据RequestDTO </p>
...
@Data
@ToString
@ApiModel(description = "网页端端埋点数据上报请求数据传输对象")
public class WebPageAcquisitionRequestDto {
