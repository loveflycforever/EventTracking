 ...
 * <p>Name: RollingBusinessAcquisitionEntity </p>
 * <p>Description: B端业务请求流水实体 </p>
...
@NoArgsConstructor
@Sharding
@Document(collection="et_ods_business_acquisition")
public class BusinessAcquisitionOdsEntity extends AutoIncrIdEntity {
    /**
     * app名称(示例 房房房)
     */
    private String app;
