 ...
 */
@Data
public class AgentCommunityRankingVo implements Serializable {
    /**
     * 日期
     */
     ...
     * 访问数
     */
    @ApiModelProperty(value = "访问数", example = "99")
     ...
     * 总访问数
     */
    @ApiModelProperty(value = "总访问数", example = "999")
    private Long totalUvAmount;


    /**
     * 总收藏量
     */
    @ApiModelProperty(value = "总收藏量", example = "999")
    private Long totalColAmount;

    /**
     * 总转发量
     */
    @ApiModelProperty(value = "总转发量", example = "999")
    private Long totalRpsAmount;
