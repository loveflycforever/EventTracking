 ...
 * <p>Name: LiveGActShareAppEntity </p>
 * <p>Description: LiveG活动维度分享统计结果 </p>
...
@Document(collection="et_dm_live_act_share")
@Builder
@AllArgsConstructor
@NoArgsConstructor
@CompoundIndexes({
...
public class LiveGActShareEntity extends BasicEntity {
