...
@Repository
@Slf4j
@TaskLabel(name = "维度[活动]APP参与人数日统计", desc = "[VIS_GAME]日周期，统计活动参与人数", order = 1)
public class LiveGActParticipantsDm extends AbstractMapReduceDmDao<LiveGActParticipantsEntity, LiveGActParticipantsRo> {
    @Override
    ...
    public String getReduceFunction() {
        return "classpath:mr/liveGActParticioantsReduce.js";
    }

    @Override
    public String getMapFunction() {
        return "classpath:mr/liveGActParticioantsMap.js";
    }
