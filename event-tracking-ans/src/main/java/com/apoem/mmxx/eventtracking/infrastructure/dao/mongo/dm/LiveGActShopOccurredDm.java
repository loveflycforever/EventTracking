 ...
 * <p>Name: LiveGActShopOccurredDm </p>
 * <p>Description: 活动+门店+位置维度 PV、UV统计 </p>
 * <p>Date: 2020/11/30 9:14 </p>
...
@Repository
@Slf4j
@TaskLabel(name = "维度[活动+门店+位置]APP PV、UV日统计", desc = "[VIS_GAME]日周期，统计访问量、访客数", order = 1)
public class LiveGActShopOccurredDm extends AbstractMapReduceDmDao<LiveGActShopOccurredEntity, LiveGActShopOccurredRo> {
    @Override
    ...
    public String getReduceFunction() {
        return "classpath:mr/liveGActShopOccurredAppReduce.js";
    }

    @Override
    public String getMapFunction() {
        return "classpath:mr/liveGActShopOccurredAppMap.js";
    }
