 ...
 */
@Repository
public interface OverviewCustomerStatsDao extends MongoRepository<OverviewCustomerStatsEntity, Object> {
     ...
     * @return 实体
     */
    OverviewCustomerStatsEntity findByCityAndDateDay(String city, Integer dateDay);
