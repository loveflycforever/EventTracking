...
import com.apoem.mmxx.eventtracking.infrastructure.po.ro.LiveGActAgentShareRo;
...
@Repository
@Slf4j
@TaskLabel(name = "维度[活动-经纪人]日统计", desc = "[RPS_GAME_H5]日周期，统计活动分享总数", order = 1)
public class LiveGActAgentShareDm extends AbstractMapReduceDmDao<LiveGActAgentShareEntity, LiveGActAgentShareRo> {
    ...
    @Override
    public Class<LiveGActAgentShareRo> mrResultClass() {
        return LiveGActAgentShareRo.class;
    }
    ...
    @Override
    public List<LiveGActAgentShareEntity> convertToTargetData(LocalDateTime localDateTime, MapReduceResults<LiveGActAgentShareRo> reduceResults) {
        Iterator<LiveGActAgentShareRo> iterator = reduceResults.iterator();
