...
@Repository
@Slf4j
@TaskLabel(name = "维度[活动-发生位置]H5访问人数日统计", desc = "[VIS_GAME]日周期，统计访问量、访客数", order = 1)
public class LiveGActOccurredH5Dm extends AbstractMapReduceDmDao<LiveGActOccurredEntity, LiveGActOccurredRo> {
    ...
    public String getReduceFunction() {
        return "classpath:mr/liveGActOccurredReduce.js";
    }

    @Override
    public String getMapFunction() {
        return "classpath:mr/liveGActOccurredMap.js";
    }
