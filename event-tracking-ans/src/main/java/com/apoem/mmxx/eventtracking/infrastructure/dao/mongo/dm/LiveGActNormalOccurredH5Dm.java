...
@Repository
@Slf4j
@TaskLabel(name = "维度[活动-测试-发生位置]H5非测试日统计", desc = "[VIS_GAME]日周期，统计访问量、访客数", order = 1)
public class LiveGActNormalOccurredH5Dm extends AbstractMapReduceDmDao<LiveGActNormalOccurredEntity, LiveGActNormalOccurredRo> {
    ...
    public String getReduceFunction() {
        return "classpath:mr/liveGActNormalOccurredReduce.js";
    }

    @Override
    public String getMapFunction() {
        return "classpath:mr/liveGActNormalOccurredMap.js";
    }
